...
try {
   ...
   cout << "Welcome to our simple calculator.\nPlease enter expressions using floating-point numbers.\nThe available operators are + - / * % '(' ')'\nalong with the sqrt and pow functions\nfunctions syntax: 'sqrt(x)' and 'pow(x y)'\n\n**note** when using the pow function, separate the x and y with a space\n\nYou may also declare your own variables using the keyword 'let'\nPlease type ';' after each query to receive an answer\nPlease type 'exit' if you wish to end the program!\n\nHappy Calculating!";
